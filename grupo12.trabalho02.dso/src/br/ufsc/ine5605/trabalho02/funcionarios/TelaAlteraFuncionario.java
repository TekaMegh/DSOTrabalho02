...
//				ControladorFuncionario.getInstance().incluiFuncionario(tfNome.getText(), (Date)tfDataNascimento.getValue(),
//						tfTelefone.getValue(), (Integer)tfSalario.getValue(), cbCargos.getSelectedItem());
