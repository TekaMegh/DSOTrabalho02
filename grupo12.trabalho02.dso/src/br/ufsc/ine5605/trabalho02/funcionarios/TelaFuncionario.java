...
public class TelaFuncionario {
	...
	/**
	 * Imprime a mensagem "Insira o salário:" e checa a validade do input recebido.
	 *
	...
	/**
	 * Imprime mensagem solicitando pela data de nascimento no formato dd/MM/yyyy.
	 *
	...
	public String printGetTelefone() {
		...
		do {
			...
			if (!telefone.matches(pattern1) && !telefone.matches(pattern2)) {
				System.out.println(
						"Formato do telefone inválido! Lembrando que é preciso digitar os parenteses\"()\" e hifen\"-\", e que não pode conter espaços. ");
	...
	/**
	 * Imprime mensagem de erro indicando a já existencia de outro funcionario com o
	 * mesmo nome informado.
	 */
	...
	public void printFuncionarioListEmptyError() {
		System.out.println(
				"Não há funcionários cadastrados no momento. Por favor, tente cadastrar um funcionário primeiro.");
	}
