...
public class ControladorFuncionario implements IControladorFuncionario {
	...
	private MapeadorFuncionario mapFunc = new MapeadorFuncionario();
	...
	public void opcaoSwitch(int opcao) {
		...
		case 2:
			...
			try {
				ControladorFuncionario.getInstance().modificaFuncionario(matricula, nome, dataNascimento, telefone,
						salario, cargo);
			} catch (Exception e) {
				TelaFuncionario.printExceptionMessage(e);
	 ...
	 */
	@Override
	public void incluiFuncionario(String nome, Date nascimento, String telefone, int salario, Cargo cargo)
			throws Exception {
		if (nome == null) {
	 ...
	 */
	@Override
	public void modificaFuncionario(int matricula, String nome, Date nascimento, String telefone, int salario,
	...
	/**
	 * Procura por funcionários associados ao cargo passado como parâmetro adiciona
	 * numa lista, a qual será impressa na tela posteriormente.
	 *
	 * @param cargo
	 */
	@Override
